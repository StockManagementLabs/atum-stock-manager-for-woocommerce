...
final class Helpers {
	...
	public static function get_visual_mode_style() {
		...
		$primary_color_light   = self::get_option( 'primary_color_light' ) ? self::get_option( 'primary_color_light' ) : '#f5fdff';
		$primary_color_dark    = self::get_option( 'primary_color_dark' ) ? self::get_option( 'primary_color_dark' ) : '#dbf9ff';
		$secondary_color       = self::get_option( 'secondary_color' ) ? self::get_option( 'secondary_color' ) : '#EFAF00';
		$secondary_color_rgb   = self::convert_hexadecimal_to_rgb( $secondary_color );
		$secondary_color_light = self::get_option( 'secondary_color_light' ) ? self::get_option( 'secondary_color_light' ) : '#fff4d6';
		$secondary_color_dark  = self::get_option( 'secondary_color_dark' ) ? self::get_option( 'secondary_color_dark' ) : '#ffedbc';
		$tertiary_color        = self::get_option( 'tertiary_color' ) ? self::get_option( 'tertiary_color' ) : '#69C61D';
		$tertiary_color_rgb    = self::convert_hexadecimal_to_rgb( $tertiary_color );
		$tertiary_color_light  = self::get_option( 'tertiary_color_light' ) ? self::get_option( 'tertiary_color_light' ) : '#69C61D';
		$tertiary_color_dark   = self::get_option( 'tertiary_color_dark' ) ? self::get_option( 'tertiary_color_dark' ) : '#b4f000c9';
		$text_color            = self::get_option( 'text_color' ) ? self::get_option( 'text_color' ) : '#6C757D';
		$text_color_rgb        = self::convert_hexadecimal_to_rgb( $text_color );
		$text_color_2          = self::get_option( 'text_color_2' ) ? self::get_option( 'text_color_2' ) : '#adb5bd';
		$text_color_2_rgb      = self::convert_hexadecimal_to_rgb( $text_color_2 );
		$border_color          = self::get_option( 'border_color' ) ? self::get_option( 'border_color' ) : '#e9ecef';
		...
		if ( 'hc_mode' === $theme_settings ) {
			...
			$style = ":root{
					...
					--green-light: $tertiary_color_dark;
					...
					--atum-table-views-tabs: $text_color_2;
					...
					--dash-add-widget-color: $text_color;
					...
					--dash-widget-header-title: $text_color_2;
					...
					--dash-stock-control-chart-border: $border_color;
		...
		elseif ( 'dark_mode' === $theme_settings ) {
			...
			$style = ":root{
					...
					--gray-500: $text_color;
					--green: $tertiary_color;
					--green-light: $tertiary_color;
					--green-light-2: $tertiary_color_light;
					--success: $tertiary_color;
					--success-hover: rgba($tertiary_color_rgb,0.6);
					--atum-page-title-action: $tertiary_color_dark;
					...
					--atum-settings-section-title: $text_color;
					--atum-settings-section-description: $text_color;
					...
					--atum-table-row-child-variation-even: $primary_color_light;
					--dash-subscription-input: rgba($text_color_rgb, 0.7);
					--dash-card-bg: $bg_1_color;
					--dash-h5-text: $primary_color;
					--dash-widget-text: $text_color_2;
					--dash-nice-select-bg: $bg_1_color;
					...
					--dash-input-placeholder: $primary_color;
					--dash-widget-header-title: $text_color;
					--dash-statistics-ticks: $text_color;
					--dash-statistics-grid-lines: rgba($text_color_rgb, 0.2);
					--dash-statistics-chart-type-bg: transparent;
					--dash-statistics-chart-type-selected-bg: $bg_1_color;
