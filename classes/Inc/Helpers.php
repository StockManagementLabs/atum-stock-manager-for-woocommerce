...
//			$primary_color = $dm_dark_blue;
			...
			$style = ":root{
				    ...
				    --atum-table-item-heads: $primary_color;
				    --atum-table-views-tabs: $primary_color;
				    ...
				    --atum-dropdown-toggle-bg: $bg_2_color;
				    --atum-pagination-bg-disabled: $bg_2_color;
				    --atum-pagination-border-disabled: $primary_color;
				    --atum-column-groups-bg: $blue_dark;
				    --atum-table-row-even: $bg_2_color;
				    --atum-table-row-odd: $bg_1_color;
					--atum-marketing-popup-bg: $tertiary_color;
					...
					--atum-table-row-variation-text: $tertiary_color;
					--atum-footer-totals: $bg_1_color;
					--atum-table-icon: $primary_color;
					--atum-table-icon-active: $tertiary_color;
					--atum-table-text-active: $tertiary_color;
					--atum-settings-nav-bg: $tertiary_color;
					--atum-settings-heads-bg: $tertiary_color;
					--atum-settings-nav-link: $primary_color;
					--atum-settings-nav-link-selected-bg: $secondary_color;
					--atum-settings-nav-link-selected: $tertiary_color;
					--atum-settings-wp-color-bg: $white;
					--atum-settings-wp-color-text: $tertiary_color;
					--atum-settings-btn-save: $secondary_color;
					--atum-settings-btn-save-text: $tertiary_color;
				    --atum-settings-btn-save-hover: rgba($secondary_color_rgb,0.6);
				    --atum-settings-input-text: $tertiary_color;
				    --atum-settings-section-bg: $tertiary_color;
				    --atum-settings-section-title: $primary_color;
				    --atum-settings-section-text: $primary_color;
				    --atum-settings-text-logo: $primary_color;
					...
					--dash-nice-select-border: rgba($primary_color_rgb, 0.5);
				    --dash-nice-select-hover: $primary_color;
				    --dash-nice-select-text: $primary_color;
				    --dash-nice-select-arrow-color: $primary_color;
					...
					--dash-widget-header-title: $primary_color;
					--dash-statistics-ticks: $primary_color;
					--dash-statistics-grid-lines: rgba($primary_color_rgb, 0.2);
					--dash-statistics-chart-type-bg: transparent;
					--dash-statistics-chart-type-selected-bg: $dm_orange;
					--dash-statistics-chart-type-selected-text: $tertiary_color;
				    ...
				    --dash-widget-text: $primary_color;
...
//					--blue: $primary_color;
//					--atum-table-row-even: #{$light};
//					--atum-table-row-odd: transparent;
//					--atum-bg-white: #{$white};
...
//					--blue-light-expanded: $tertiary_color;
//					--green-light-expanded: #{$green-light};
//					--atum-page-title-action: #{$success};
//					--atum-border: #{$gray-200};
//					--atum-table-item-heads: $secondary_color;
//					--atum-table-views-tabs: $secondary_color;
//					--atum-table-views-tabs-active: $primary_color;
...
//					--atum-row-active: $tertiary_color;
//					--atum-table-row-variation-text: #{$white};
//					--atum-table-row-child-variation-even: #{$blue-light-2};
//					--atum-table-row-child-variation: $tertiary_color;
//					--atum-table-link-active: $primary_color;
//					--atum-table-check: $primary_color;
...
//					--atum-settings-nav-link-selected: $primary_color;
//					--atum-settings-nav-link-selected-bg: $tertiary_color;
//					--atum-settings-section-title: #{$blue-dark};

//					--atum-settings-section-description: $secondary_color;
//					--atum-settings-text-logo: #{$white};
//					--atum-settings-input-border: #{$gray-200};

//					--atum-settings-btn-save: #{$white};
//					--atum-settings-btn-save-text: $primary_color;
//					--atum-settings-btn-save-hover: $tertiary_color;
//					--atum-settings-wp-color-bg: transparent;

//					--wp-nth-child: #{$gray-100};
//					--dash-card-text: $secondary_color;
//					--dash-widget-text: #{$widget-text};
//					--dash-atum-version: transparentize(#{$black}, 0.9);
//					--dash-widget-primary: #{$widget-primary};
//					--dash-widget-success: #{$widget-success};
//					--dash-widget-warning: #{$widget-warning};
//					--dash-widget-danger: #{$widget-danger};
//					--dash-nice-select-bg: #{$white};
//					--dash-nice-select-list-bg: #{$white};
//					--dash-nice-select-text: $secondary_color;
//					--dash-nice-select-border: #{$gray-200};
...
//					--dash-nice-select-option-selected-bg: $tertiary_color;
//					--dash-nice-select-text-highlighted: $primary_color;
