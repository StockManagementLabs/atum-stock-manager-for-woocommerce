...
final class Helpers {
	...
	public static function is_atum_ajax() {
		...
		return defined( 'DOING_AJAX' ) && DOING_AJAX && ! empty( $_REQUEST['action'] ) && 'atum_' === substr( $_REQUEST['action'], 0, 5 );
	}
	...
	public static function get_visual_mode_style() {
		...
		$black                 = '#000000';
		$black_rgb             = self::convert_hexadecimal_to_rgb( $black );
		$blue                  = '#00b8db';
		$blue_dark             = '#27283b';
		$green                 = '#69C61D';
		$orange                = '#EFAF00';
		$primary_color         = self::get_option( $prefix . 'primary_color' ) ? self::get_option( $prefix . 'primary_color' ) : $blue;
		$primary_color_rgb     = self::convert_hexadecimal_to_rgb( $primary_color );
		$primary_color_light   = self::get_option( $prefix . 'primary_color_light' ) ? self::get_option( $prefix . 'primary_color_light' ) : '#f5fdff';
		$primary_color_dark    = self::get_option( $prefix . 'primary_color_dark' ) ? self::get_option( $prefix . 'primary_color_dark' ) : '#dbf9ff';
		$secondary_color       = self::get_option( $prefix . 'secondary_color' ) ? self::get_option( $prefix . 'secondary_color' ) : '#EFAF00';
		$secondary_color_rgb   = self::convert_hexadecimal_to_rgb( $secondary_color );
		$secondary_color_light = self::get_option( $prefix . 'secondary_color_light' ) ? self::get_option( $prefix . 'secondary_color_light' ) : '#fff4d6';
		$secondary_color_dark  = self::get_option( $prefix . 'secondary_color_dark' ) ? self::get_option( $prefix . 'secondary_color_dark' ) : '#ffedbc';
		$tertiary_color        = self::get_option( $prefix . 'tertiary_color' ) ? self::get_option( $prefix . 'tertiary_color' ) : $green;
		$tertiary_color_rgb    = self::convert_hexadecimal_to_rgb( $tertiary_color );
		$tertiary_color_light  = self::get_option( $prefix . 'tertiary_color_light' ) ? self::get_option( $prefix . 'tertiary_color_light' ) : $green;
		$tertiary_color_dark   = self::get_option( $prefix . 'tertiary_color_dark' ) ? self::get_option( $prefix . 'tertiary_color_dark' ) : '#b4f000c9';
		$text_color            = self::get_option( $prefix . 'text_color' ) ? self::get_option( $prefix . 'text_color' ) : '#6C757D';
		$text_color_rgb        = self::convert_hexadecimal_to_rgb( $text_color );
		$text_color_2          = self::get_option( $prefix . 'text_color_2' ) ? self::get_option( $prefix . 'text_color_2' ) : '#adb5bd';
		$text_color_2_rgb      = self::convert_hexadecimal_to_rgb( $text_color_2 );
		$text_color_expanded   = self::get_option( $prefix . 'text_color_expanded' ) ? self::get_option( $prefix . 'text_color_expanded' ) : $white;
		$border_color          = self::get_option( $prefix . 'border_color' ) ? self::get_option( $prefix . 'border_color' ) : '#e9ecef';
		$border_color_rgb      = self::convert_hexadecimal_to_rgb( $border_color );
		$bg_1_color            = self::get_option( $prefix . 'bg_1_color' ) ? self::get_option( $prefix . 'bg_1_color' ) : $white;
		...
		if ( 'hc_mode' === $theme_settings ) {
			...
			$secondary_color_light = $primary_color_light;
			$secondary_color_dark  = $primary_color_dark;
			$tertiary_color        = $primary_color;
			$tertiary_color_light  = $primary_color_light;
			$tertiary_color_dark   = $primary_color_dark;
			$text_color            = '#016B7F';
			$text_color_2          = '#27283b';
			...
			$style = ":root{
					...
					--primary-hover: $white;
					--primary-hover-text: $primary_color;
					--primary-hover-border: solid 1px $primary_color;
					--orange: $secondary_color;
					--dash-blue-trans: $primary_color_light;
					...
					--white-shadow: rgba($border_color_rgb,0.2);
					--green-light: $primary_color_dark;
				    ...
				    --atum-row-active: $primary_color_dark;
					...
					--atum-footer-bg: $white;
					--atum-dropdown-toggle-bg: $gray_100;
					--atum-icon-tree: $text_color;
					--atum-settings-nav-link-selected: $primary_color;
					--atum-settings-nav-link-selected-bg: $primary_color_dark;
					...
					--atum-table-row-child-variation: $primary_color_dark;
					--atum-table-row-child-variation-even: $primary_color_light;
				    ...
				    --dash-nice-select-hover: $primary_color;
				    --dash-nice-select-text: $text_color_2;
				    --dash-nice-select-arrow-color: $text_color;
				    --dash-nice-select-option-hover: $primary_color_light;
				    --dash-nice-select-option-selected-bg: $primary_color_light;
				    --dash-nice-select-text-highlighted: $primary_color;
					--dash-input-group-bg: rgba($bg_1_color_rgb, 0.3);
					--dash-input-group-shadow: rgba($bg_1_color_rgb, 0.3);
					--dash-input-placeholder: $primary_color;
					--dash-widget-header-title: $title_color;
					--dash-statistics-ticks: $text_color;
					--dash-statistics-grid-lines: rgba($text_color_rgb, 0.2);
					...
					--atum-version: $blue_dark;
					--atum-version-bg: rgba($black_rgb, 0.1);
					--atum-table-filter-dropdown: $blue_dark;
					--atum-footer-title: $blue_dark;
		...
		elseif ( 'dark_mode' === $theme_settings ) {
			...
			$style = ":root{
					--wp-yiq-text-light: $text_color_2;
					--danger: $danger_color;
					--blue: $primary_color;
					...
					--primary-hover-text: $blue_dark;
					--primary-hover-border: 1px solid transparent;
					--orange: $orange;
					--atum-pagination-border-disabled: rgba($border_color_rgb,0.0);
					--orange-light-2: $secondary_color_light;
					--orange-light: $secondary_color_dark;
					--warning: $secondary_color; 
					--warning-hover: rgba($secondary_color_rgb,0.6); 
					--warning-hover-text: $blue_dark;
					--warning-hover-border: 1px solid transparent;
					--gray-600: $text_color;
					--gray-500: $text_color;
					--green: $tertiary_color_light;
					--green-light: rgba($tertiary_color_rgb,0.6);
					--green-light-2: $tertiary_color_light;
					--success: $tertiary_color;
					--success-hover: rgba($tertiary_color_rgb,0.6);
					--success-hover-text: $blue_dark;
					--success-hover-border: 1px solid transparent;
					--atum-page-title-action: $tertiary_color_light;
					--atum-table-item-heads: $text_color;
					--atum-table-row-even: $bg_2_color;
					--blue-hover: rgba($primary_color_rgb,0.6);
				    --atum-table-row-odd: $bg_1_color;
				    --atum-column-groups-bg: $blue_dark;
				    --atum-border: rgba($border_color_rgb,0.2);
				    --atum-border-expanded: rgba($border_color_rgb,0.2);
				    --popover-black-shadow: rgba($border_color_rgb,0.2);
				    --atum-table-row-variation-text: $text_color_2;
				    --atum-row-active: $primary_color_light;
				    --js-scroll-bg: $text_color;
					--atum-table-views-tabs: $text_color;
					--atum-table-views-tabs-active: $primary_color;
					--atum-table-views-tabs-active-text: $text_color_2;
					--atum-table-link-child: $primary_color_dark;
					--atum-input-placeholder: $text_color;
					--atum-select2-selected-text: $primary_color_dark;
					--atum-select2-selected-bg: $primary_color_light;
					--atum-table-link-active: $primary_color_dark;
					--atum-table-check: $primary_color_dark;
					--atum-table-bg: $bg_1_color;
					--atum-table-icon: $text_color;
					--atum-table-icon-active: $text_color_2;
					--atum-table-text-active: $text_color_2;
					--atum-table-text-expanded: $text_color_expanded;
					--atum-table-search-text: $blue_dark;
					--atum-table-search-text-disabled: $blue_dark;
					--atum-table-search-bg: $secondary_color;
					--atum-pagination-bg-disabled: $bg_2_color;
					--atum-pagination-disabled: $text_color;
					--atum-pagination-text: $text_color_2;
					--atum-footer-totals: $blue_dark;
					--atum-footer-bg: $blue_dark;
					--atum-dropdown-toggle-bg: $bg_2_color;
					--atum-icon-tree: $text_color;
					--atum-settings-nav-bg: $bg_1_color;
					--atum-settings-heads-bg: $bg_1_color;
					--atum-settings-nav-link: $text_color;
					--atum-settings-section-bg: $bg_1_color;
					--atum-settings-nav-link-selected: $text_color_2;
					--atum-settings-nav-link-selected-bg: $primary_color_light;
					--atum-settings-section-title: $title_color;
					--atum-settings-section-description: $text_color;
					--atum-settings-btn-save: $primary_color;
					--atum-settings-btn-save-hover: rgba($primary_color_rgb,0.7);
					--atum-settings-btn-save-text: $text_color_2;
					--atum-settings-btn-save-text-hover: $text_color_2;
					--atum-settings-text-logo: $text_color;
					--atum-settings-separator: rgba($border_color_rgb,0.2);
					--overflow-opacity-rigth: linear-gradient(to right, rgba($bg_1_color_rgb,0), rgba($bg_1_color_rgb,0.9));
					--overflow-opacity-left: linear-gradient(to left, rgba($bg_1_color_rgb,0), rgba($bg_1_color_rgb,0.9));
					--dash-border: rgba($text_color_rgb, 0.5);
					--dash-card-text: $text_color;
					--dash-nice-select-text: $text_color;
					--dash-nice-select-disabled-after: lighten($text_color_rgb, 20%);
					--dash-nice-select-arrow-color: $text_color;
					--dash-nice-select-text-highlighted: $primary_color;
					--dash-add-widget-color: $gray_500;
					--dash-add-widget-color-dark: $blue_dark;
					--dash-input-placeholder: $text_color;
					--atum-settings-section-text: $text_color;
					--atum-settings-input-text: $text_color_2;
					--atum-settings-border-color: rgba($border_color_rgb,0.2);
					--atum-settings-wp-color-text: $text_color;
					--atum-table-row-child-variation: $primary_color_light;
					--atum-table-row-child-variation-even: $primary_color_light;
					--dash-subscription-input: transparent;
					--dash-card-bg: $bg_1_color;
					--dash-h5-text: $primary_color;
					--dash-nice-select-bg: $bg_1_color;
					--dash-nice-select-list-bg: $bg_1_color;
					--dash-nice-select-border: rgba($text_color_rgb, 0.5);
				    --dash-nice-select-hover: $primary_color_light;
				    --dash-nice-select-text: $text_color;
				    --dash-nice-select-arrow-color: $text_color;
				    --dash-nice-select-option-hover: $primary_color_light;
				    --dash-nice-select-option-selected-bg: $primary_color_light;
				    --dash-nice-select-text-highlighted: $primary_color_dark;
					...
					--dash-statistics-chart-type-selected-text: $secondary_color;
					--dash-statistics-legend-switch-bg: transparent;
					--dash-widget-separator: rgba($border_color_rgb,0.2);
					--dash-widget-primary: $primary_color;
				    --dash-widget-success: $tertiary_color;
				    --dash-widget-warning: $secondary_color_light;
				    --dash-widget-danger: $danger_color;
				    --dash-widget-text: $text_color;
					--dash-stats-data-widget-primary: $primary_color_light;
				    --dash-stats-data-widget-success: $tertiary_color;
					--dash-stock-control-chart-border: $blue_dark;
					--dash-next-text: $gray_500;
					--dash-video-title: $text_color;
					--dash-video-subs-text: $gray_500;
					--atum-marketing-popup-bg: $bg_1_color;
					--atum-select2-border: rgba($border_color_rgb,0.5);
					--atum-add-widget-bg: $blue_dark;
					--atum-add-widget-title: $text_color;
					--atum-add-widget-separator: rgba($border_color_rgb,0.2);
					--atum-table-filter-dropdown: $white;
					--atum-footer-title: $white;
					--atum-footer-link: $primary_color;
					--atum-footer-text: $white;
					--atum-table-link-text: $text_color_expanded;
			}";
		}else {
			...
			$style = ":root{
					...
					--primary: $primary_color;
					--primary-hover: rgba($primary_color_rgb,0.6);
					--primary-hover-text: $text_color_expanded;
					--primary-hover-border: 1px solid transparent;
					--orange: $secondary_color;
					--orange-light-2: $secondary_color_light;
					--orange-light: $secondary_color_dark;
					--warning: $secondary_color; 
					--warning-hover: rgba($secondary_color_rgb,0.6);
					--warning-hover-text: $text_color_expanded;
					--warning-hover-border: 1px solid transparent;
					--gray-600:$text_color;
					--green: $tertiary_color;
					--green-light: rgba($tertiary_color_rgb,0.6);
					...
					--success: $tertiary_color;
					--success-hover: rgba($tertiary_color_rgb,0.6);
					--success-hover-text: $text_color_expanded;
					--success-hover-border: 1px solid transparent;
					--atum-page-title-action: $tertiary_color;
					--atum-table-item-heads: $text_color_2;
					--atum-table-row-even: $bg_2_color;
					...
					--atum-table-text-expanded: $text_color_expanded;
					--atum-table-search-text: $text_color_expanded;
					--atum-table-search-text-disabled: $text_color_expanded;
					--atum-table-search-bg: $secondary_color;
					--atum-settings-heads-bg: $primary_color;
					--atum-settings-nav-link: $primary_color;
					--atum-pagination-bg-disabled: $bg_2_color;
					--atum-pagination-disabled: $text_color;
					--atum-pagination-text: $text_color;
					--atum-footer-totals: $bg_1_color;
					--atum-footer-bg: $white;
					--atum-dropdown-toggle-bg: $bg_2_color;
					--atum-icon-tree: $text_color;
					...
					--atum-settings-btn-save-hover: rgba($white_rgb,0.7);
					--atum-settings-btn-save-text: $primary_color;
					--atum-settings-btn-save-text-hover: $primary_color;
					...
					--dash-nice-select-text-highlighted: $primary_color;
					--dash-add-widget-color: $gray_500;
					--dash-add-widget-color-dark: $primary_color;
					--dash-input-placeholder: $text_color;
					--dash-video-title: $dark;
					--dash-video-subs-text: $text_color;
					--dash-widget-separator: $border_color;
					--atum-settings-section-text: $text_color;
					--atum-settings-input-text: $text_color;
					--atum-settings-wp-color-text: $text_color;
					...
					--dash-widget-primary: $primary_color;
				    --dash-widget-success: $tertiary_color;
				    --dash-widget-warning: $secondary_color;
				    --dash-widget-danger: $danger_color;
					--dash-widget-header-title: $title_color;
				    --dash-statistics-chart-type-selected-text: $secondary_color;
				    --dash-widget-text: $text_color;
				    ...
				    --dash-stats-data-widget-success: $tertiary_color;
				    --atum-select2-border: $border_color;
				    --atum-table-filter-dropdown: $gray_500;
				    --atum-footer-title: $blue_dark;
				    --atum-table-link-text: $text_color;
			}";
			// --atum-settings-switch-bg:
		}
