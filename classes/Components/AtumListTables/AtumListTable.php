...
abstract class AtumListTable extends \WP_List_Table {
	...
	protected function display_tablenav( $which ) {
		...
		<div class="tablenav <?php echo esc_attr( $which ); ?>">
			...
			<div id="scroll-filters_container" class="filters-containe-box <?php echo 'top' === $which && isset( $this->_pagination_args ) && $this->_pagination_args['total_pages'] <= 1 ? 'not-pagination' : ''; ?> ">
