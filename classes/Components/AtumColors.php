...
class AtumColors {
	...
	public function get_high_contrast_mode_colors() {
		...
		$scheme = ":root {
		    ...
		    --primary-dark-bg: {$this->colors['primary_color_dark']};
			--secondary: $secondary_color;
			--secondary-var: $secondary_color;
			--secondary-light-var: $secondary_color_light;
	...
	public function get_dark_mode_colors() {
		...
		$scheme = ":root {
		    ...
		    --primary-dark-bg: {$this->colors['primary_color_light']};
			--secondary: {$this->colors['secondary_color']}; 
			--secondary-var: {$this->colors['secondary_color_dark']};
			--secondary-light-var: {$this->colors['secondary_color']};
			...
			--atum-text-color: {$this->colors['text_color']};
	...
	public function get_branded_mode_colors() {
		...
		$scheme = ":root {
			...
			--secondary-light-var: {$this->colors['secondary_color_light']};
