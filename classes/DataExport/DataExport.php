...
class DataExport {
	...
	public function enqueue_scripts( $hook ) {
		...
		if ($hook == 'toplevel_page_' . Globals::ATUM_UI_SLUG ) {
			...
			wc_product_dropdown_categories( array(
				'show_count'         => 0,
				'option_select_text' => __( 'Show all categories' )
			) );
	...
	public function export_data() {
		...
		$header = (array) apply_filters( 'atum/data_export/report_page_header', array(
			'L'    => array(
				'content'     => __( 'ATUM Stock Central Report' ),
				'font-size'   => 8,
				'font-style'  => 'I',
				'font-family' => 'serif',
				'color'       => '#666666'
		...
		$footer = (array) apply_filters( 'atum/data_export/report_page_footer', array(
			'L'    => array(
				'content'     => __( 'Report generated by DATA EXPORT, a free ATUM add-on.' ),
				'font-size'   => 8,
				'font-style'  => 'I',
				'font-family' => 'serif',
				'color'       => '#666666'
		...
		/*echo '<style>' . $common_stylesheet . $wc_admin_stylesheet . $atum_stylesheet .
		     "
				@font-face {
					font-family: 'WooCommerce';
					src: url('" . ATUM_URL . "assets/fonts/WooCommerce.ttf');			
					font-weight: normal;
					font-style: normal;
				}
				@font-face {
					font-family: dashicons;
				    src: url('" . ATUM_URL . "assets/fonts/dashicons.ttf');					
					font-weight: normal;
					font-style: normal;
				}
			</style>";
