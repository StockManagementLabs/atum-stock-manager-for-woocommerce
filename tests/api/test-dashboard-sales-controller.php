<?php
/**
 * Class DashboardSalesControllerTest
 *
 * @package Atum_Stock_Manager_For_Woocommerce
 */

use Atum\Api\Controllers\V3\DashboardSalesController;
use TestHelpers\TestHelpers;

class DashboardSalesControllerTest extends WP_UnitTestCase {
	public function test_methods() {
		$data = TestHelpers::count_public_methods( DashboardSalesController::class );
	...
	public function test_instance() {
		$obj = new DashboardSalesController();
		$this->assertInstanceOf( DashboardSalesController::class, $obj );
	}
