...
use Atum\Api\Controllers\V3\PurchaseOrderNotesController;
use Atum\PurchaseOrders\PurchaseOrders;
use TestHelpers\TestHelpers;

class AtumOrderNotesControllerTest {
	// Abstract class, tested in next class
}

/**
 * Sample test case.
 */
class PurchaseOrderNotesControllerTest extends WP_UnitTestCase {
	public function test_methods() {
		$data = TestHelpers::count_public_methods( PurchaseOrderNotesController::class );
	...
	public function test_instance() {
		$obj = new PurchaseOrderNotesController();
		$this->assertInstanceOf( PurchaseOrderNotesController::class, $obj );
	}
