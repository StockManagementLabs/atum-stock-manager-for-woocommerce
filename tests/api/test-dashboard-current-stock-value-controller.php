<?php
/**
 * Class DashboardCurrentStockValueControllerTest
 *
 * @package Atum_Stock_Manager_For_Woocommerce
 */

use Atum\Api\Controllers\V3\DashboardCurrentStockValueController;
use TestHelpers\TestHelpers;

class DashboardCurrentStockValueControllerTest extends WP_UnitTestCase {
	public function test_methods() {
		$data = TestHelpers::count_public_methods( DashboardCurrentStockValueController::class );
	...
	public function test_instance() {
		$obj = new DashboardCurrentStockValueController();
		$this->assertInstanceOf( DashboardCurrentStockValueController::class, $obj );
	}
