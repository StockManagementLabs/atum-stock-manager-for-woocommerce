<?php
/**
 * Class DashboardPromoSalesControllerTest
 *
 * @package Atum_Stock_Manager_For_Woocommerce
 */

use Atum\Api\Controllers\V3\DashboardPromoSalesController;
use TestHelpers\TestHelpers;

class DashboardPromoSalesControllerTest extends WP_UnitTestCase {
	public function test_methods() {
		$data = TestHelpers::count_public_methods( DashboardPromoSalesController::class );
	...
	public function test_instance() {
		$obj = new DashboardPromoSalesController();
		$this->assertInstanceOf( DashboardPromoSalesController::class, $obj );
	}
