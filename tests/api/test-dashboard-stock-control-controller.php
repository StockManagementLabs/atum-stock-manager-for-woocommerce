<?php
/**
 * Class DashboardStockControlControllerTest
 *
 * @package Atum_Stock_Manager_For_Woocommerce
 */

use Atum\Api\Controllers\V3\DashboardStockControlController;
use TestHelpers\TestHelpers;

class DashboardWidgetControllerTest {
	//DashboardWidgetController abstract class tested in the following test class
}

class DashboardStockControlControllerTest extends WP_UnitTestCase {
	public function test_methods() {
		$data = TestHelpers::count_public_methods( DashboardStockControlController::class );
	...
	public function test_instance() {
		$obj = new DashboardStockControlController();
		$this->assertInstanceOf( DashboardStockControlController::class, $obj );
	}
