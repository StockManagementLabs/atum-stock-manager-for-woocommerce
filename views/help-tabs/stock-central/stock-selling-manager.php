	...
	<tbody>
		...
		<tr>
			...
			<td>
				...
				<p><i class="atum-icon atmi-arrow-down-circle" style="color: #00B8DB"></i> <?php esc_html_e( 'Product is in Restock Status and Managed by WC.', ATUM_TEXT_DOMAIN ) ?></p>
				<p><i class="atum-icon atmi-circle-minus" style="color: #EFAF00"></i> <?php esc_html_e( 'Product is Out of Stock, but Managed by WC and Set to Backorders.', ATUM_TEXT_DOMAIN ) ?></p>
				...
				<p><i class="atum-icon atmi-question-circle" style="color: #EFAF00"></i> <?php esc_html_e( 'Product set to Backorders Only and Not Managed by WC.', ATUM_TEXT_DOMAIN ) ?></p>
			</td>
		</tr>
	</tbody>
</table>
