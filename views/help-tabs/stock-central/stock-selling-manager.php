...
<table class="widefat fixed striped">
	...
	<tbody>
		...
		<tr>
			...
			<td>
				<p><i class="dashicons dashicons-yes" style="color: #82C342"></i> <?php esc_html_e( 'Product In Stock and Managed by WC.', ATUM_TEXT_DOMAIN ) ?></p>
				<p><i class="dashicons dashicons-dismiss" style="color: #FF4848"></i> <?php esc_html_e( 'Product Out of Stock and Managed by WC.', ATUM_TEXT_DOMAIN ) ?></p>
				<p><i class="dashicons dashicons-warning" style="color: #EFAF00"></i> <?php esc_html_e( 'Product is Low Stock and Managed by WC.', ATUM_TEXT_DOMAIN ) ?></p>
				<p><i class="dashicons dashicons-visibility"></i> <?php esc_html_e( 'Product is Out of Stock, but Managed by WC and Set to Back Orders.', ATUM_TEXT_DOMAIN ) ?></p>
				<p><i class="dashicons dashicons-hidden" style="color: #82C342"></i> <?php esc_html_e( 'Product In Stock and Not Managed by WC.', ATUM_TEXT_DOMAIN ) ?></p>
				<p><i class="dashicons dashicons-hidden" style="color: #FF4848"></i> <?php esc_html_e( 'Product Out of Stock and Not Managed by WC.', ATUM_TEXT_DOMAIN ) ?></p>
				<p><i class="dashicons dashicons-hidden" style="color: #00B8DB"></i> <?php esc_html_e( 'Product set to Back Orders Only and Not Managed by WC.', ATUM_TEXT_DOMAIN ) ?></p>
			</td>
		</tr>
	</tbody>
</table>
