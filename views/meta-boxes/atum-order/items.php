...
$post_search = PurchaseOrders::get_post_type() === $post_type->name && 'auto-draft' !== $atum_order->get_status() ? 'data-limit="' . $atum_order->get_id() . '"' : '';
?>
					...
					<article>
						...
						<form action="" method="post">
							<select class="wc-product-search atum-enhanced-select" multiple="multiple" style="width: 50%;" id="add_item_id" name="add_atum_order_items[]"
								...
								<?php echo esc_attr( $post_search ); ?>></select>
						</form>
					</article>
