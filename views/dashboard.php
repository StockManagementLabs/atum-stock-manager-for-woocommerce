...
<div class="atum-dashboard">
	...
	<section class="dash-header">
		...
		<div class="dash-header-buttons">
			<!--<a href="#" target="_blank" type="button" class="btn btn-success btn-pill"><?php _e('Upgrade Now', ATUM_TEXT_DOMAIN) ?></a>-->
			<a href="<?php echo $support_link ?>" target="_blank" class="btn btn-primary btn-pill"><?php echo $support_button_text ?></a>
	...
	<section class="dash-cards owl-carousel owl-theme">
		...
		<div class="dash-card docs">
			...
			<div class="card-content">
				...
				<a href="https://forum.stockmanagementlabs.com/t/atum-documentation" class="btn btn-primary btn-pill" target="_blank"><?php _e('View Tutorials', ATUM_TEXT_DOMAIN) ?></a>
			</div>
		...
		<div class="dash-card add-ons">
			...
			<div class="card-content">
				...
				<a href="https://www.stockmanagementlabs.com/addons/" class="btn btn-success btn-pill" target="_blank"><?php _e('View Add-ons', ATUM_TEXT_DOMAIN) ?></a>
			</div>
		...
		<div class="dash-card subscription">
			...
			<form action="https://stockmanagementlabs.us12.list-manage.com/subscribe/post?u=bc146f9acefd460717d243671&id=b0263fe4a6" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
				<div class="input-group">
					...
					<button type="submit" class="btn btn-warning btn-pill" name="subscribe" id="mc-embedded-subscribe"><?php _e('Subscribe', ATUM_TEXT_DOMAIN) ?></button>
				</div>
			</form>
				...
				<ul class="widgets-list">
					...
					<?php foreach ($widgets as $widget_name => $widget): ?>
						<li data-widget="<?php echo $widget_name ?>" class="<?php echo ( empty($layout) || ! is_array($layout) || ! in_array($widget_name, array_keys($layout)) ) ? 'not-added' : 'added' ?>">
							...
							<div>
								<button type="button" class="add-widget btn btn-primary btn-sm btn-pill"><?php _e('Add Widget', ATUM_TEXT_DOMAIN) ?></button>
								<button type="button" class="btn btn-info btn-sm btn-pill" disabled><i class="lnr lnr-checkmark-circle"></i> <?php _e('Added', ATUM_TEXT_DOMAIN) ?></button>
							</div>
						</li>
					<?php endforeach; ?>
