...
<div class="atum-statistics-widget">
	...
	<div class="atum-table config-table left table-today">
		<table>
			<thead>
			<tr>
				<th colspan="2">
	...
	<div class="atum-table config-table right table-current-month">
		<table>
			<thead>
			<tr>
				<th colspan="2">
	...
	<div class="atum-table config-table left table-totals">
		<table>
			<thead>
			<tr>
				<th colspan="2">
	...
	<div class="atum-table config-table right table-revenue">
		<table>
			<thead>
			<tr>
				<th colspan="2">
	...
	<div class="atum-table config-table left table-promo-products">
		<table>
			<thead>
			<tr>
				<th colspan="2">
	...
	<div class="atum-table config-table right table-promo-value">
		<table>
			<thead>
			<tr>
				<th colspan="2">
...
<script type="text/javascript">
	jQuery(function($){
		...
		// Initialize
		$configTables.find('.section-checkbox').change();
