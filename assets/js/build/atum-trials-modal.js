...
/* harmony export */ });
/*!
* sweetalert2-neutral v11.14.1-neutral-fix2
...
/* harmony export */ });
/* harmony import */ var sweetalert2_neutral__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! sweetalert2-neutral */ "./node_modules/sweetalert2-neutral/dist/sweetalert2.esm.all.js");
...
var Trials = (function () {
    ...
    Trials.prototype.extendTrialConfirmation = function (addon, key) {
        var _this = this;
        sweetalert2_neutral__WEBPACK_IMPORTED_MODULE_0__["default"].fire({
            ...
            preConfirm: function () {
                return _this.extendTrial(addon, key, true, function (response) {
                    if (!response.success) {
                        sweetalert2_neutral__WEBPACK_IMPORTED_MODULE_0__["default"].showValidationMessage(response.data);
                    }
                    else {
                        sweetalert2_neutral__WEBPACK_IMPORTED_MODULE_0__["default"].fire({
