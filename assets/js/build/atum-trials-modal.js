...
/* harmony export */ });
/* harmony import */ var sweetalert2_neutral__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! sweetalert2-neutral */ "sweetalert2-neutral");
/* harmony import */ var sweetalert2_neutral__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(sweetalert2_neutral__WEBPACK_IMPORTED_MODULE_0__);
...
var Trials = (function () {
    ...
    Trials.prototype.extendTrialConfirmation = function (addon, key) {
        var _this = this;
        sweetalert2_neutral__WEBPACK_IMPORTED_MODULE_0___default().fire({
            ...
            preConfirm: function () {
                return _this.extendTrial(addon, key, true, function (response) {
                    if (!response.success) {
                        sweetalert2_neutral__WEBPACK_IMPORTED_MODULE_0___default().showValidationMessage(response.data);
                    }
                    else {
                        sweetalert2_neutral__WEBPACK_IMPORTED_MODULE_0___default().fire({
