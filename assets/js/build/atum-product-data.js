        ...
        this.wpHooks.addAction('atum_fileUploader_selected', 'atum', function (uploader) {
            ...
            attachments.forEach(function (attachment) {
                ...
                if (['jpg', 'jpeg', 'jpe', 'gif', 'png', 'webp', 'svg'].includes(attachment.subtype) && attachment.sizes.medium.url) {
                    thumb = "<img src=\"".concat(attachment.sizes.medium.url, "\" alt=\"").concat(attachment.title, "\">");
                }
                else {
    ...
    function ProductDataMetaBoxes(settings) {
        ...
        $('.product-tab-runner').find('.run-script').on('click', function (evt) {
            ...
            sweetalert2_neutral__WEBPACK_IMPORTED_MODULE_2__["default"].fire({
                        ...
                        $.ajax({
                            ...
                            success: function (response) {
                                if (typeof response !== 'object' || response.success !== true) {
                                    sweetalert2_neutral__WEBPACK_IMPORTED_MODULE_2__["default"].showValidationMessage(response.data);
                                }
                ...
                allowOutsideClick: function () { return !sweetalert2_neutral__WEBPACK_IMPORTED_MODULE_2__["default"].isLoading(); },
            })
