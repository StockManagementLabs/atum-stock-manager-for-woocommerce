...
var AddonsPage = (function () {
    ...
    AddonsPage.prototype.licenseChangeResponse = function (resp, message, addon, key, isSwal) {
        ...
        switch (resp) {
            case false:
                if (isSwal) {
                    sweetalert2__WEBPACK_IMPORTED_MODULE_2___default().showValidationMessage("<span>".concat(message, "</span>"));
                }
                else {
                    ...
                    preConfirm: function () {
                        return new Promise(function (res) {
                            $.ajax({
                                ...
                                success: function (r) {
                                    if (r.success !== true) {
                                        sweetalert2__WEBPACK_IMPORTED_MODULE_2___default().showValidationMessage("<span>".concat(r.data, "</span>"));
                                    }
                                    res();
                                },
                            });
    ...
    AddonsPage.prototype.initHorizontalDragScroll = function () {
        var _this = this;
        ...
        _vendor_dragscroll__WEBPACK_IMPORTED_MODULE_1___default().reset();
    };
    ...
    AddonsPage.prototype.navIsRight = function (navEl) {
...
var AutoInstaller = (function () {
    ...
    AutoInstaller.prototype.run = function () {
        ...
        sweetalert2__WEBPACK_IMPORTED_MODULE_0___default().fire({
            ...
            allowEscapeKey: function () { return !sweetalert2__WEBPACK_IMPORTED_MODULE_0___default().isLoading(); },
            showLoaderOnConfirm: true,
            preConfirm: function () {
                ...
                success: function (response) {
                    if (false !== response.success) {
                        _this.addonsPage.installAddon(addon, key)
                            ...
                            sweetalert2__WEBPACK_IMPORTED_MODULE_0___default().showValidationMessage("<span><strong>".concat(addon, ":</strong> ").concat(error, "</span>"));
                            reject(error);
                        });
                    }
                    else {
                        _this.setAddonStatus(addon, 'error');
                        sweetalert2__WEBPACK_IMPORTED_MODULE_0___default().showValidationMessage("<span><strong>".concat(addon, ":</strong> ").concat(response.data, "</span>"));
                        reject(response.data);
                    }
                }
            });
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (AutoInstaller);
...
/*!*********************************!*\
  ...
  \*********************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _components_addons_addons_page__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/addons/_addons-page */ "./assets/js/src/components/addons/_addons-page.ts");
